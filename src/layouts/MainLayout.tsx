    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      <header className="bg-primary shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link to="/" className="text-white text-2xl font-bold hover:text-white transition-all duration-300 transform hover:scale-105">
            WUDI FYI
          </Link>
          <nav>
            <ul className="flex items-center space-x-6">
              <li>
                <Link to="/" className="text-white hover:text-primary-light font-medium transition-all duration-300">Home</Link>
              </li>
              {currentSeason && (
        ...
        <div className="container mx-auto px-4 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-primary-light">Westchester Ultimate Disc, Inc.</p>
            </div>
            
            <div>
              <h3 className="text-xl font-bold mb-4">Contact</h3>
              <p className="mb-2">Email: <a href={`mailto:${wudiInfo.contact_email || 'theboard@wudi.org'}`} className="text-primary-light hover:text-white transition-all duration-300">{wudiInfo.contact_email || 'theboard@wudi.org'}</a></p>
              <p>Emergency: <a href={`tel:${wudiInfo.emergency_number || '9142516900'}`} className="text-primary-light hover:text-white transition-all duration-300">{wudiInfo.emergency_number || '914.251.6900'}</a></p>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-600 text-center">
            <p className="text-sm text-primary-light">&copy; {new Date().getFullYear()} Westchester Ultimate Disc, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
